...
export class UsuariosService {
  ...
  postUsuario(formData: any){
    return this.http.post(`${this.api_test}/usuarios`, formData)
  }
  putUsuario(id: string, formData: any){
    return this.http.put(`${this.api_test}/usuarios/${id}`, formData)
  }
  postGarantia(formData: any, id_cliente: string){
    return this.http.post(`${this.api_test}/usuarios/${id_cliente}/garantias`, formData)
  }
  ...
  getClientesBaja(){
    return this.http.get(`${this.api_test}/usuarios/baja`)
  }
  ...
  deletePhotos(id_cliente: string, id_garantias: any){
    return this.http.patch(`${this.api_test}/usuarios/${id_cliente}/garantias`, {public_ids: id_garantias} )
  }
